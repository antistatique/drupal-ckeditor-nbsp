...
## [3.1.2] - 2026-05-20
### Changed
- chore(cspell): add cspell exception for sirbrillig

### Added
- build(composer): allow composer plugin drupal/core-composer-scaffold
...
[Unreleased]: https://github.com/antistatique/drupal-ckeditor-nbsp/compare/3.1.2...HEAD
[3.1.2]: https://github.com/antistatique/drupal-ckeditor-nbsp/compare/3.1.1...3.1.2
